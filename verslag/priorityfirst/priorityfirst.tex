...
\begin{figure}[h]
	\includegraphics[width=0.5\linewidth]{priorityfirst/DIJKSTRA_graph1}
	\centering
...
\begin{figure}[h]
	\includegraphics[width=0.5\linewidth]{priorityfirst/DIJKSTRA_graph2}
	\centering
